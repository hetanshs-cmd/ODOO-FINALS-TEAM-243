...
export const Errors = {
  ...
  businessRuleViolation: (message: string) => new AppError('BUSINESS_RULE_VIOLATION', 422, message),

  internalError: () => new AppError('INTERNAL_SERVER_ERROR', 500, 'An unexpected error occurred'),
} as const;
